...
class LitModule(LightningModule):
    def __init__(self, params):
        ...
        self.net_g = HiFiGAN(**params.hifi_gan)
        self.net_d = Discriminator()

        self.spec_tfm = SpectrogramTransform(**params.audio)
        self.pqmf = PQMF()

        self.sub_stft_loss = MultiResolutionSTFTLoss(**params.multi_resolution_stft_loss)
    ...
    def _handle_batch(self, batch, train=True):
        ...
        y_hat, y_hat_m = self.net_g(y_mel)
        ...
        loss_stft = self.sub_stft_loss(y_m, y_hat_m)
